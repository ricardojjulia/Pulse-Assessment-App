...
scraping known URLs, interacting with live pages when plain extraction
is not enough, crawling docs, mapping a site, parsing local documents,
searching research papers, or monitoring pages for changes.
...
endpoints. Move to one as soon as it is available.
